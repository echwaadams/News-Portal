...
public class Sql2oUserDaoTest {
    ...
    public void setUp() throws Exception {
        ...
        Sql2o sql2o = new Sql2o(connectionStr, "echwaadams","password");

        userDao = new Sql2oUserDao(sql2o);
        con = sql2o.open();
        userDao.clearAllUsers(); // starts with empty table
    }
    ...
    public void getAllUsers_ReturnsAllUsers_True() {
        ...
        assertEquals(userDao.getAllusers().containsAll(Arrays.asList(u1,u2)));
    ...
    public void findUserById_ReturnsCorrectUser_True() {
        ...
        assertTrue(u1, foundUser);
    }

    @Test
    public void updateUser_UpdateUserNamePositionRoleDepartment_True() {
        User u1 = setUpUser();
        User u2 = setUpUser();
        userDao.addUser(u1);
        userDao.addUser(u2);
        ...
        userDao.updateUser(u1, "Adams Lucky","Senior", "CSO",2);
        ...
        assertNotEquals(ol_department, u2.getDepartmentId());
        assertNotEquals(ol_name, u2.getName());
        assertNotEquals(ol_position,u2.getPosition());
        assertNotEquals(ol_role, u2.getRole());
    }

    @Test
    public void clearAllUsers_clearAllUsers_True() {
        User u1 = setUpUser();
        User u2 = setUpUser();
        userDao.adduser(u1);
        userDao.addUser(u2);
    ...
    public User setUpUser(){
        return new User(0,"Senior","Glyne","Admin",1)
    }
}